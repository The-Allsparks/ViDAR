...
def _build_camera_profile_json(
    ...
    flat: dict[str, Any] = {
        ...
        "horizonRowPx": camera.get("horizonRowPx", 18),
        "focalLengthPx": camera.get("focalLengthPx", 492),
        "focalLengthYPx": camera.get("focalLengthYPx", camera.get("focalLengthPx", 492)),
        "principalPointX": camera.get("principalPointX", 640),
        "principalPointY": camera.get("principalPointY", 360),
        "horizontalFovDeg": camera.get("horizontalFovDeg", 105),
        "verticalFovDeg": camera.get("verticalFovDeg", 72),
...
def _parse_camera_profile(raw: dict[str, Any]) -> CameraProfile:
    ...
    return CameraProfile(
        ...
        horizon_row_px=int(raw.get("horizonRowPx", 18)),
        focal_length_px=float(raw.get("focalLengthPx", 492)),
        floor_cy_px=cy,
        floor_dist=dist,
        focal_length_y_px=float(raw.get("focalLengthYPx", raw.get("focalLengthPx", 492))),
        principal_point_x=float(raw.get("principalPointX", 640)),
        principal_point_y=float(raw.get("principalPointY", 360)),
        horizontal_fov_deg=float(raw.get("horizontalFovDeg", 105)),
        vertical_fov_deg=float(raw.get("verticalFovDeg", 72)),
