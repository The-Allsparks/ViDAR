 ...
 * States: PRIMARY, SECONDARY, IDLE (manual only), DEEP_IDLE (stream stop after delay).
...
public final class VidarCameraScheduler {
    ...
    public enum State {
        ...
        /** Full processing: element + plate + tag schedule. */

        PRIMARY,

        /** Lightweight element only; expensive processors disabled. */
    ...
    private boolean contourEnabled = true;
    ...
    public State tierForCamera(double cameraBearingDeg, double travelHeadingDeg, double speedInPerSec) {
        ...
        // Never auto-idle — use SECONDARY for rear-facing cameras when direction scheduling is enabled.
    ...
    public void apply(VisionPortal portal,
        ...
        if (contour != null) {
            ...
            portal.setProcessorEnabled(contour, contourEnabled);
        ...
        if (metrics != null) {
            ...
            int active = (contourEnabled ? 1 : 0) + (tagEnabled ? 1 : 0);
